  ...
  return (
    ...
    >
      <div className="p-4">
        ...
        <ul className="mt-4">
          <li className="mb-2"><Link to="/teacher-dashboard/" className="block hover:text-indigo-400">Home</Link></li>
          <li className="mb-2"><Link to="/teacher-dashboard/schedule" className="block hover:text-indigo-400">Schedule</Link></li>
